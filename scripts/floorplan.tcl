...
read_verilog {./../DC/results/full_adder.mapped.v} -library RIPPLE_ADDER_LIB -design ripple_adder -top ripple_adder
...
save_block -as fulladder_orient1
save_lib -as fulladder_orient1
...
save_block -as fulladder_orient9
save_lib -as fulladder_orient9
...
save_block as full_adder8
save_lib as full_adder8
